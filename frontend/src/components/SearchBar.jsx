...
const SearchBar = ({ useridOne , alluser }) => {
    ...
    return (
        ...
        >
            <img style={{width:"8%", height:"8%",cursor:"pointer"}} alt="filter" src="https://img.icons8.com/ios-filled/50/000000/search--v1.png"/>
            <Input
                type="text"
                id="header-search"
                ...
                <ListDiv>
                    ...
                    searchVal ? (
                        <ListItem key={user.userId}>
                            <ProfileImage style={{ width: "25%", height: "40%" }} src={user.profilePicture || {DefaultProfile} } alt="Profile Image" />
